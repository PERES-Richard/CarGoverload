...
export class BookingsController {
    ...
    @Get(':wishId/status')
    getBookingStatus(@Param('wishId') wishId: string) {
        return this.bookingsService.validationsResult.get(wishId) ? this.bookingsService.validationsResult.get(wishId) : null
    }
}
