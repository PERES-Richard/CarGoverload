...
func (s *TrackingService) GetCars(latitude string, longitude string, carType string) []entities.Car{
	...
	cars := []entities.Car{
		{Id: 1, CarType: entities.CarType{Name: "Solid", Id: 1}},
		{Id: 2, CarType: entities.CarType{Name: "Liquid", Id: 2}},
		{Id: 3, CarType: entities.CarType{Name: "Liquid", Id: 2}},
		{Id: 4, CarType: entities.CarType{Name: "Solid", Id: 1}},
